	...
	if ( is_front_page() or thinkup_check_ishome() ) {
		...
		echo '<div id="section-home"><div id="section-home-inner">';
			...
			echo	'</div>',
					...
					'<p><a href="http://NorthAZRE.com" class="more-link themebutton" target="_blank">' . __( 'Search Properties', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>'; */
			...
			echo '<article class="section1 one_third">',
					...
					if ( empty( $thinkup_homepage_section1_image ) ) {
						...
						<h3 class="white">' . esc_html( $thinkup_homepage_section1_title ) . '</h3></div>',
				 	'</div>',
				 	'<div class="entry-content">';
					} else {
						echo '<img src="' . $thinkup_homepage_section1_image[0] . '"  alt="" />',
						'<div class="entry-content">',
						'<h3>' . esc_html( $thinkup_homepage_section1_title ) . '</h3>';
					}
			echo	'' . wpautop( do_shortcode ( esc_html( $thinkup_homepage_section1_desc ) ) ),
					'<p><a href="http://NorthAZRE.com" class="more-link themebutton" target="_blank">' . __( 'Search Properties', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>';
			...
			echo '<article class="section2 one_third">',
					...
					if ( empty( $thinkup_homepage_section2_image ) ) {
						echo '<div class="sectionHeader">
						<h3 class="white">' . esc_html( $thinkup_homepage_section2_title ) . '</h3></div>',
				 	'</div>',
				 	'<div class="entry-content">';
					} else {
						echo '<img src="' . $thinkup_homepage_section2_image[0] . '"  alt="" />',
						'<div class="entry-content">',
						'<h3>' . esc_html( $thinkup_homepage_section2_title ) . '</h3>';
					}
			echo	'' . wpautop( do_shortcode ( esc_html( $thinkup_homepage_section2_desc ) ) ),
					'<p><a href="http://northazre.yourkwagent.com/atj/user/CMAFormGetAction.do" class="more-link themebutton" target="_blank">' . __( 'List Property', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>';
			...
			echo '<article class="section3 one_third last">',
					...
					if ( empty( $thinkup_homepage_section3_image ) ) {
						echo '<div class="sectionHeader">
						<h3 class="white">' . esc_html( $thinkup_homepage_section3_title ) . '</h3></div>',
				 	'</div>',
				 	'<div class="entry-content">';
					} else {
						echo '<img src="' . $thinkup_homepage_section3_image[0] . '"  alt="" />',
						'<div class="entry-content">',
						'<h3>' . esc_html( $thinkup_homepage_section3_title ) . '</h3>';
					}
			echo	'' . wpautop( do_shortcode ( esc_html( $thinkup_homepage_section3_desc ) ) ),
					'<p><a href="http://kingman-az-homes.com" class="more-link themebutton" target="_blank">' . __( 'Get Info', 'lan-thinkupthemes' ) . '</a></p>',
					'</div>',
					'</div>',
				'</article>';
